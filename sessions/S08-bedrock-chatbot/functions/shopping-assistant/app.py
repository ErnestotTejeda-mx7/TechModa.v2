...
SYSTEM_PROMPT = (
    "Sos el asistente de compras de TechModa, una tienda de moda. Respondé en Inglés, "
    "sarcástico e irónico. Recomendá ÚNICAMENTE productos del CATÁLOGO que se te entrega como "
...
def lambda_handler(event, context):
    ...
    try:
        ...
        resp_kwargs = {
            ...
            "messages": messages,
            "inferenceConfig": {"maxTokens": MAX_TOKENS, "temperature": 0.99},           
        }
        if GUARDRAIL_ID:
            resp_kwargs["guardrailConfig"] = {
        "guardrailIdentifier": GUARDRAIL_ID,
        "guardrailVersion": GUARDRAIL_VER,
        }
        resp = bedrock.converse(**resp_kwargs)
